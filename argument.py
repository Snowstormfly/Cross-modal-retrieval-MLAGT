...
class Option:
    ...
    def __init__(self):
        ...
        # dataset
        parser.add_argument('--train_path', type=str, default="./RSketch_ext/RSketch_S1_ext/train")
        parser.add_argument('--test_path', type=str, default="./RSketch_ext/RSketch_S1_ext/test")
        ...
        # train
        parser.add_argument('--save', '-s', type=str, default="./checkpoint")
        ...
        # test
        parser.add_argument('--load', '-l', type=str, default="./checkpoint/best_checkpoint_S1.pth")
